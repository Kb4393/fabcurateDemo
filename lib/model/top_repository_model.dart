class TopRepositoryModel {
  ...
  TopRepositoryModel({this.mainStickyMenu, this.status, this.message});

  TopRepositoryModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (mainStickyMenu != null) {
      data['main_sticky_menu'] = mainStickyMenu!.map((v) => v.toJson()).toList();
    }
    data['status'] = status;
