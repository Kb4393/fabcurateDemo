...
class MiddleRepositoryModel {
  ...
  MiddleRepositoryModel({this.shopByCategory, this.shopByFabric, this.unstitched, this.boutiqueCollection, this.status, this.message});

  MiddleRepositoryModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (shopByCategory != null) {
      data['shop_by_category'] = shopByCategory!.map((v) => v.toJson()).toList();
    }
    ...
    if (boutiqueCollection != null) {
      data['boutique_collection'] = boutiqueCollection!.map((v) => v.toJson()).toList();
    }
    data['status'] = status;
